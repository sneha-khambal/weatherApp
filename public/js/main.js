...
weatherStatus.innerText =  tempData.weather[0].main;
  if(tempData.weather[0].main == "Rain"){
   weathericon.innerHTML="<img src='images/rain.png' style='width:100px;height:100px;'>";
  }
  if(tempData.weather[0].main == "Clear"){
   weathericon.innerHTML="<img src='images/clear.png' style='width:50px;height:50px;'>";
  }
  if(tempData.weather[0].main == "Sunny"){
   weathericon.innerHTML="<img src='images/sunny.png' style='width:50px;height:50px;'>";
  }
  ...
  if(tempData.weather[0].main == "Smoke"){
   weathericon.innerHTML="<img src='images/smoke.png' style='width:50px;height:50px;'>";
  }
  if(tempData.weather[0].main == "Thunderstorm"){
   weathericon.innerHTML="<img src='images/thunderStrom.png' style='width:50px;height:50px;'>";
  }
  temp.innerHTML =  tempData.main.temp +"<span>&deg;</span>";
  errortext.innerText="";
  }catch(err){
   errortext.innerText = 'Please check your Internet connection \n or enter proper city name ';
   }    
